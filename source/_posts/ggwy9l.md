...
toc: false
mathjax: false
summary: Java 的学习，除了思想，本质还是在学习一个个类的使用！
categories: java常用类
tags:
  - java
  - JavaSE
...
ok,那么从今天开始，我们就正式开始迈入 Java 常用类的学习了.之前呢，我们已经学习了面向对象相关的知识，也算正式踏入了 Java 开发的大门了，那么后面的课程都属于是高级部分学习了！
...
![](https://cdn.nlark.com/yuque/0/2021/png/21990331/1625834179913-c811c902-4828-4b85-8747-c60f6ed60705.png#id=izxbe&originHeight=343&originWidth=310&originalType=binary∶=1&status=done&style=none)
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834180300-39e83fed-5b23-4743-bc53-ae71cd12e885.jpeg#id=LMoCC&originHeight=326&originWidth=651&originalType=binary∶=1&status=done&style=none)
...
![](https://cdn.nlark.com/yuque/0/2021/png/21990331/1625834180692-a6e98f49-66a0-40d1-9ab9-908a4843695f.png#id=Va7RI&originHeight=202&originWidth=942&originalType=binary∶=1&status=done&style=none)​
方法中的异常：
![](https://cdn.nlark.com/yuque/0/2021/png/21990331/1625834180922-e83a7edd-753c-4895-b800-9a5a1ac19082.png#id=eIBzA&originHeight=72&originWidth=837&originalType=binary∶=1&status=done&style=none)
...
![](https://cdn.nlark.com/yuque/0/2021/png/21990331/1625834181226-ff88ada3-5dba-4bf5-a2ea-7636fe7e67d3.png#id=NhqTC&originHeight=265&originWidth=539&originalType=binary∶=1&status=done&style=none)[
可能这里还是不够明显，构造方法实例化方式的内存图：String str = new String("Hello");
首先：
![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834181602-7eb959cb-d929-4a29-bd4e-8bfa86385ad0.jpeg#id=S45jz&originHeight=210&originWidth=371&originalType=binary∶=1&status=done&style=none)​
当我们再一次的 new 一个 String 对象时：

![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834181919-2401676a-a32f-4aff-9500-03caed7ca8ef.jpeg#id=L37mz&originHeight=188&originWidth=406&originalType=binary∶=1&status=done&style=none)​
​
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834182205-2d4be391-aaad-4750-9dde-8c794355fcdd.jpeg#id=joUND&originHeight=184&originWidth=564&originalType=binary∶=1&status=done&style=none)

## 3、String 常用的方法

![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834182477-a710310e-efcf-4693-9bd8-e84bacec7154.jpeg#id=NfOgK&originHeight=512&originWidth=755&originalType=binary∶=1&status=done&style=none)​
...
内存图分析：
![](https://cdn.nlark.com/yuque/0/2021/png/21990331/1625834182830-ac7be430-ae3d-4a59-9f71-2c4308883f83.png#id=Qkosj&originHeight=224&originWidth=399&originalType=binary∶=1&status=done&style=none)​
...
1. 当我们的程序运行时，也就是说 JVM 运行时，每个 Class constant_pool table 中的内容会被加
   载到 JVM 内存中的方法区中各自 Class 的 Runtime Constant Pool。
1. 一个没有被 String Pool 包含的 Runtime Constant Pool 中的字符串（这里是"hello"）会被加入到
   String Pool 中（HosSpot 使用 hashtable 引用方式），步骤如下：
...
![](https://cdn.nlark.com/yuque/0/2021/jpeg/21990331/1625834183138-e8f9867d-b065-4d1d-b2ce-7d058275861f.jpeg#id=cEhbd&originHeight=239&originWidth=359&originalType=binary∶=1&status=done&style=none)​
...
对于三者使用的总结：
1） 如 果 要 操 作 少 量 的 数 据 用 = String
2）单线程操作字符串缓冲区 下操作大量数据 = StringBuilder
3）多线程操作字符串缓冲区 下操作大量数据 = StringBuﬀer
